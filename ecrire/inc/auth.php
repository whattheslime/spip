 ...
 * @return bool
 */
function auth_controler_password_auteur_connecte(
	#[\SensitiveParameter]
	string $password
): bool {
 ...
 * @return mixed
 */
function auth_identifier_login(
	$login,
	#[\SensitiveParameter]
	$password,
	$serveur = '',
