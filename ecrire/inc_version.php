...
// trois au lieu de 3 pour la version maj pour ne pas déclancher le message de bas de page dans une version 2.1 ou < ecrire/genie/mise_a_jour.php
$spip_version_branche = "Trois.1.0-alpha";
