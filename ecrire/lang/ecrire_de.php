...
Ihr Status wird durch die Farbe ihres Symbols angezeigt (Redakteur = gelb; Administrator = grün). ',
	...
	'info_pour' => 'für',
	'info_preview_texte' => 'Man kann sich die Website so anzeigen lassen, als ob alle Artikel veröffentlicht wären, die mindestens den Status « vorgeschlagen » haben. Wem soll diese Möglichkeit zur Verfügung stehen (Adminsitratoren, Redakteure, niemand)?', # MODIF
