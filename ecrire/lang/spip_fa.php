...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'date_fmt_jour_heure_debut_fin' => ' @jour@ از @heure_debut@ تا @heure_fin@',
	'date_fmt_jour_heure_debut_fin_abbr' => '@dtstart@@jour@ de @heure_debut@@dtabbr@ تا @dtstart@@heure_fin@@dtend@', # MODIF
