...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'activer_plugin' => 'چالاککەردەو لکەکا',
	'affichage' => 'نیشاندای',
	'aide_non_disponible' => 'ئی بەشەو کۊمەکە ئۆنلاینە پی زۋانە ۋەرو دەسیەنە نییا.',
	'annuler_recherche' => 'Cancel the search',
	'auteur' => 'نۋیسەر:',
	'avis_acces_interdit' => 'ئاگادارکەردەی دەسپنەیاۋای.',
	'avis_article_modifie' => 'Warning: @nom_auteur_modif@ modified this article @date_diff@ minutes ago',
	'avis_aucun_resultat' => 'ھیچ سەرەنجامېۋ نەئېزیاۋە.',
	'avis_base_inaccessible' => 'Impossible to connect to the database @base@.',
	'avis_chemin_invalide_1' => 'ئا ئاراستە کە تۊ دیاریکەردەن',
	'avis_chemin_invalide_2' => 'does not seem to be valid. Please return to the previous page and verify the information provided.',
	'avis_connexion_echec_1' => 'پەیوەندیگېرتەی بە خزمەتگوزاری زۋانو بەرۋزتەو پەیکەرەی (SQL) سەرشنەگېرت',
	'avis_connexion_echec_2' => 'گېڵۆ پەڕەی ۋەڵین و چە ئا زانیارییەکا دڵنیاییکەرۆ کە وېت دەینۍ. ',
	...
	'avis_erreur_connexion_mysql' => 'ھەڵە چە پەیوەندی زۋانو خزمەتگزاری پەیکەرەی (SQL)',
	...
	'avis_operation_echec' => 'چالاکییەکە سەرنمەگېرۊ.',
	...
	'bouton_ajouter' => 'زیاڎکەرردەی',
	'bouton_annuler' => 'پەشیمانبیەی',
	...
	'config_info_logos_utiliser_non' => 'لۆگۆ بەکانمارە',
	...
	'connexion_ldap' => 'پەیوەندی:',
	'creer_et_associer_un_auteur' => 'نۋیسەرېۋ درۊسکەرە و  بنیەرە',

	// D
	'date_mot_heures' => 'H',

	// E
	'ecran_securite' => '+  @version@نیشاندەری پاریېزیا',
	'email' => 'email',
	'email_2' => 'email:',
	...
	'entree_cle_pgp' => 'کڕېڵو پارېزنای تایبەتییەکا وێت',
	'entree_cle_pgp_2' => 'کڕېڵو پارېزنای تایبەتییەکا وېت (PGP)',
	...
	'entree_infos_perso' => 'تۊ کېنی؟',
	'entree_infos_perso_2' => 'نۋیسەرەکە کېن؟',
	'entree_interieur_rubrique' => 'چە بەشەکەنە:',
	'entree_liens_sites' => '<b>Hyperlink</b> (reference, site to visit etc.)',
	'entree_login' => 'لۋایچۊەی تۊ',
	...
	'entree_mot_passe_1' => 'واژەی نھېنی',
	...
	'entree_nom_site' => 'نامۊ پەڕیانەکەیت',
	'entree_nom_site_2' => 'نامۊ نۋیسەرو پەڕیانەی',
