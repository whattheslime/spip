...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'date_fmt_jour_heure_debut_fin' => '@jour@ from @heure_debut@ to @heure_fin@', # MODIF
	'date_fmt_jour_heure_debut_fin_abbr' => '@dtstart@@jour@ from @heure_debut@@dtabbr@ to @dtend@@heure_fin@@dtabbr@', # MODIF
