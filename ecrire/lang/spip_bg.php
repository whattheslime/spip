...
// extrait automatiquement de https://trad.spip.net/tradlang_module/spip_?lang_cible=bg
...
на сайта @nom_site_spip@ (@adresse_login@):',
	...
	'form_prop_enregistre' => 'Вашето предложение е записано. То ще се появи на страниците на сайта след одобрение от администратор. ', # MODIF
	...
	'info_contact_developpeur' => 'Моля, свържете се с някой разработчик.', # MODIF
...
<span style="color:red;">опитайте се<a href=\'@script@\'>да поправите базата данни</a>, или се свържете с доставчика си.</span>',
	...
	'info_installer_ftp' => 'Като администратор можете да качите файлове (чрез FTP) в папката @upload@, за да ги използвате направо от там, когато Ви потрябват по-късно.', # MODIF
	...
	'info_nom_non_utilisateurs_connectes' => 'Името Ви е изключено от списъка на свързаните към Интернет потребители', # MODIF
	'info_nom_utilisateurs_connectes' => 'Името Ви е добавено в списъка на свързаните към Интернет потребители', # MODIF
...
------------------',
	...
	'info_symbole_jaune' => 'Символът <b>жълто</b> указва  <b>съобщение към всички редактори</b>: то може да се вписва само от администратори и да се вижда от всички редактори.', # MODIF
	'info_symbole_vert' => 'Символът <b>зелено</b> указва <b>съобщения, обменени с други потребители</b> на сайта.', # MODIF
   ...
   на навигатора и ',
	...
	'pass_erreur_code_inconnu' => '<b>Грешка:</b> този код не съвпада с никой посетител, който има разрешение за достъп до сайта.', # MODIF
...
в процес на обработка, да изпращате статии и да участвате във всички форуми.', # MODIF
	'pass_forum_bla' => 'Пожелали сте да участвате във форум, който
е запазен за регистрирани посетители.', # MODIF
...
да подновите достъпа си до сайта.', # MODIF
  ...
  презаредете навигатора си, ако се налага.',
	...
	'texte_inc_meta_1' => 'Системата намери грешка при опит за запис във файла <code>@fichier@</code>. Като администратор на сайта, моля да направите ', # MODIF
