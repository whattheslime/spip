...
return [
	...
	'avis_connexion_ldap_echec_3' => 'Без използване на LDAP-поддръжка за вписване на потребители.', # MODIF
  ...
  поради съображения за сигурност (какъвто е случаят с много доставчици).',
	...
	'bouton_radio_apparaitre_liste_redacteurs_connectes' => 'Добяване към списъка на текущо свързаните редактори', # MODIF
	...
	'bouton_radio_non_apparaitre_liste_redacteurs_connectes' => 'Изключване от списъка на текущо свързаните редактори', # MODIF
	...
	// C
	'cache_modifiable_webmestre' => 'Параметърът може да бъде променен от уеб-администратора. ', # MODIF
	...
	'entree_informations_connexion_ldap' => 'Моля, попълнете бланката с информацията за LDAP връзка. Тази информация ще получите от системния или мрежовия администратор.', # MODIF
 ...
 улеснено превключване между публичния сайт и личната зона.',
	...
	'info_administrateur_1' => 'Администратор', # MODIF
	'info_administrateur_2' => 'на сайта (<i>внимавайте</i>)',
	'info_administrateur_site_01' => 'Ако сте администратор на сайта, моля', # MODIF
	'info_administrateur_site_02' => 'посещаване на препратката',
	'info_administrateurs' => 'Администратори', # MODIF
  ...
  автоматично галерия от изображения.',
	...
	'info_chemin_acces_2' => 'От сега нататък Вие трябва да определяте пътя за достъп до данните в директорията. Тази информация дава възможност за преглед на потребителските профили, съхранени там.', # MODIF
...
', # MODIF
	...
	'info_forums_abo_invites' => 'Сайтът Ви съдържа форуми посредством предварителен абонамент; посетителите могат да се регистират за тях през публичния сайт.', # MODIF
	'info_gauche_auteurs' => 'Тук ще намерите всички автори на сайта.
 Статусът на всеки от тях е обозначен с цвета на неговата икона (редактор - жълта; администратор - зелена).', # MODIF
	...
	'info_gauche_messagerie' => 'Изпращането на съобщения позволява да се обменя информация между редакторите, да се съхраняват бележки (за лично ползване) или да се публикуват обяви в началната страница на личната зона (ако сте администратор).', # MODIF
 ...
 в публичната зона на сайта (форумите са с предварително записване).',
  ...
  на СПИП не работят:',
	...
	'info_images_auto' => 'Автоматично изчислени изображения', # MODIF
	'info_informations_personnelles' => 'Стъпка пет: <b>Лични данни</b>',
	'info_inscription_automatique' => 'Автоматична регистрация на нови редактори', # MODIF
	...
	'info_liste_redacteurs_connectes' => 'Списък на свързаните редактори', # MODIF
 ...
 е по-стара от тази, показана на този сайт
  ...
  Езиците, които вече са използвани в сайта (в началото на списъка) не могат да бъдат деактивирани.', # MODIF
  ...
  (напр. съобщения за наскоро публикуваните статии и новини).',
	...
	'info_option_accepter_visiteurs' => 'Позволяване регистрацията на посетители от публичния сайт', # MODIF
	'info_option_ne_pas_accepter_visiteurs' => 'Отказ за регистрация на посетител', # MODIF
 ...
 за да може базата данни да се адаптира към новата версия на СПИП.',
	...
	'info_question_accepter_visiteurs' => 'Ако шаблоните на сайта Ви позволяват посетителите да се регистират без да влизат в личната зона, активирайте следната опция:', # MODIF
  ...
  не би могла да се осъществи.', # MODIF
	...
	'info_reserve_admin' => 'Този адрес може да се променя само от администратори.', # MODIF
	...
	'info_statut_utilisateurs_1' => 'Статус "по подразбиране" на вписаните потребители', # MODIF
	'info_statut_utilisateurs_2' => 'Изберете статус за хората, вписани в LDAP-директорията при свързването им за първи път. По-късно ще можете да променяте тази характеристика за всеки автор по отделно.', # MODIF
...
Преводите са свързани с оригинала в цвят, посочващ техния статус:',
	...
	'item_choix_administrateurs' => 'администратори', # MODIF
	...
	// T
	'taille_cache_image' => 'Изображенията, изчислени автоматично от СПИП (умалени изображения, заглавия, преобразени в графики, математически формули в TeX формат и др.) заемат общо @taille@ в директорията @dir@.', # MODIF
...
да се преинсталира СПИП, за да се създаде нова база данни и първи администраторски достъп.', # MODIF
	...
	'texte_annuaire_ldap_1' => 'Ако разполагате с достъп до (LDAP) директория, можете да я използвате, за да вписвате автоматично потребители в СПИП.', # MODIF
...
<li> езикът по подразбиране на данните в личната зона.</li></ul>',
 ...
 случаи, когато са направени важни изменения в графиките или структурата на сайта.',
  ...
  предупредителни съобщения.', # MODIF
	'texte_vide' => 'празно',
