...
return [
	...
	'avis_connexion_erreur_fichier_cle_manquant_1' => 'Установку повинен виконати вебмастер, який має резервні копії ключів та їх паролів', # MODIF
	'avis_connexion_erreur_fichier_cle_manquant_2' => 'Установку повинен виконати вебмастер, який має резервні копії ключів ', # MODIF
	...
	'avis_connexion_ldap_echec_3' => 'Крім того, не використовуйте підтримку LDAP для імпорту користувачів.', # MODIF
	...
	'bouton_radio_apparaitre_liste_redacteurs_connectes' => 'Показувати у переліку авторів, що знаходяться на сайті', # MODIF
	...
	'bouton_radio_non_apparaitre_liste_redacteurs_connectes' => 'Не показувати у переліку авторів, що знаходяться на сайті', # MODIF
	...
	// C
	'cache_modifiable_webmestre' => 'Цей параметр може бути змінений тільки вебмастером.', # MODIF
	...
	'entree_informations_connexion_ldap' => 'Будь ласка, вкажіть параметри підключення до LDAP. Ви можете отримати цю інформацію у вашого системного адміністратора.', # MODIF
	...
	'info_admin_statuer_webmestre' => 'Надати цьому адміністратору права веб-майстра', # MODIF
	'info_admin_webmestre' => 'Адміністратор є <b>вебмастером</b>', # MODIF
	'info_administrateur' => 'Адміністратор', # MODIF
	'info_administrateur_1' => 'Адміністратор', # MODIF
	'info_administrateur_2' => 'на цьому сайті (<i>використовувати з пересторогою</i>)',
	'info_administrateur_site_01' => 'Якщо ви адміністратор сайта, будь ласка', # MODIF
	'info_administrateur_site_02' => 'натисніть тут',
	'info_administrateurs' => 'Адміністратори', # MODIF
	...
	'info_chemin_acces_2' => 'Тепер ви повинні налаштувати шлях доступу до інформації в  довіднику. Ця інформація необхідна для перегляду профілів користувачів, записаних в  довіднику.', # MODIF
	...
	'info_email_webmestre' => 'E-mail веб-мастера', # MODIF
	...
	'info_facilite_suivi_activite' => 'SPIP може повідомляти по електронній пошті,  щодо нових запитів на публікацію та схвалення статей. Вкажіть одну або кілька адрес, розділених комами.', # MODIF
	'info_fichiers_authent' => 'Файл аутентифікації «.htpasswd»',
	'info_forums_abo_invites' => 'Ваш сайт має форуми за підпискою; відвідувачі можуть зареєструватися на них на основному сайті.', # MODIF
	'info_gauche_auteurs' => 'Перелік всіх авторів сайту. Статус автора позначений кольором (адміністратор = зелений; автор = жовтий).', # MODIF
	...
	'info_gauche_messagerie' => 'Передача повідомлень дозволяє обмінюватися повідомленнями між редакторами, зберигати нотатки (для вашого особистого використання) або показувати оголошення на основній сторінці адміністративної частини (якщо ви - адміністратор).', # MODIF
	...
	'info_images_auto' => 'Кеш файлів зображень', # MODIF
	'info_informations_personnelles' => 'Налаштування профиля',
	'info_inscription' => 'Реєстрація',
	'info_inscription_automatique' => 'Автоматична реєстрація нових авторів', # MODIF
	...
	'info_liste_redacteurs_connectes' => 'Автори онлайн', # MODIF
	...
	'info_multi_langues_choisies' => 'Виберіть мови для редагування матеріалів на сайті. Мови, які вже використовує ваш сайт (наверху списку) не можуть бути вимкнені.', # MODIF
  ...
  (недавно опубліковані статті і новини).',
	...
	'info_option_accepter_visiteurs' => 'Увімкнути реєстрацію відвідувачів на сайті', # MODIF
	'info_option_ne_pas_accepter_visiteurs' => 'Відключити реєстрацію відвідувачів на сайті', # MODIF
	...
	'info_pour' => 'для',
	'info_preview_texte' => 'Налаштування попереднього перегляду. Ви можете подивитися, як виглядають на сайті матеріали зі статусом «представлено». Увімкнути цю можливість для усіх авторів, тільки для адміністраторов або відключити взагалі?', # MODIF
	...
	'info_question_accepter_visiteurs' => 'Якщо шаблони вашого сайту дозволяють відвідувачам реєструватися, не входячи в адміністративну частину, будь ласка, включіть наступну опцію:', # MODIF
	'info_question_inscription_nouveaux_redacteurs' => 'Ви хочете дозволити реєстрацію нових користувачів на сайті? Якщо так, то відвідувачі зможуть реєструватися самостійно, використовуючи стандартну форму. Також у них буде доступ в адміністративну частину сайту і можливість створювати нові матеріали.  <div class="notice">Пароль для доступу буде відправлено користувачу  email’ом автоматично. Якщо ваш хостінг не підтримує відправку листів, то ця опція буде марна.</div>', # MODIF
	...
	'info_reserve_admin' => 'Тільки адміністратори можуть змінити цю адресу.', # MODIF
	...
	'info_statut_administrateur' => 'Адміністратор', # MODIF
	...
	'info_statut_utilisateurs_1' => 'Усталений (default) статус для імпортованих користувачів', # MODIF
	'info_statut_utilisateurs_2' => 'Виберіть статус, що буде використовуватися для людей з каталогу LDAP, коли вони підключаться вперше. Пізніше ви зможете змінити це значення для кожного автора індивідуально.', # MODIF
	...
	'info_webmestre_forces' => 'Список вебмастерів міститься в <tt>@file_options@</tt>.', # MODIF
	...
	'item_administrateur_2' => 'адміністратор', # MODIF
	...
	'item_choix_administrateurs' => 'адміністратори', # MODIF
	...
	'taille_cache_image' => 'Кеш файлів зображень (автоматично стиснені картинки, зображення формул в форматі TeX і текст, трасформований в графіку) займає @taille@ в каталозі @dir@.', # MODIF
	...
	'texte_admin_effacer_01' => 'Ця команда видаляє <i>увесь</i> вміст бази даних, включаючи <i>усі</i> параметри доступу для редакторів і адміністраторів. Після її виконання ви повинні перевстановити SPIP, щоб відновити нову базу даних і доступ першого адміністратора.', # MODIF
	...
	'texte_annuaire_ldap_1' => 'Якщо ви маєте доступ до каталогу(LDAP), то можете використовувати його для автоматичного імпорту користувачів SPIP.', # MODIF
	...
	'texte_auteur_messagerie' => 'Цей сайт може постійнно контролювати список редакторів, які знаходяться он-лайн, що дозволяє вам обмінюватися повідомленнями в реальному часі. Ви можете вирішити не з’являтися в цьому списку (тоді вас «не побачать» інші користувачі).', # MODIF
	...
	'texte_messagerie_agenda' => 'Система відправлення повідомлень дозволяє авторам сайту спілкуватися безпосередньо в редакційній частині сайту. Вона пов’язана з календарем.', # MODIF
...
<li>усталену мову для адміністративной частини.</li>
	...
	'texte_travail_collaboratif' => 'Якщо декілька авторів редагують одну і ту ж саму статтю, то система позначає її як «в роботі» і обмежує доступ до неї, щоб уникнути втрат інформації внаслідок одночасного редагування матеріалу. Зазвичай цю можливість відключено.', # MODIF
	'texte_vide' => 'очистити',
