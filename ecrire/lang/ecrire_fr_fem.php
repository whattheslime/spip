...
exige d’avoir un accès FTP au site Web.</p>',
 ...
 Leur statut est indiqué par la couleur de leur icône (administratrice = vert ; rédactrice = jaune).',
	...
	'info_pour' => 'pour',
	'info_preview_texte' => 'Il est possible de prévisualiser le site comme si tous les articles et les brèves (ayant au moins le statut « proposé ») étaient publiés. Cette possibilité doit-elle être ouverte aux administratrices seulement, à tous les rédactrices, ou à personne ?', # MODIF
