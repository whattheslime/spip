...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_ajout_participant' => 'La participante suivante est ajouté :',
	...
	'info_forums_abo_invites' => 'Votre site comporte des forums sur abonnement; les visiteuses sont donc invités à s\'enregistrer sur le site public.',
...
exige d\'avoir un accès FTP au site Web.</p>',
 ...
 Leur statut est indiqué par la couleur de leur icone (administratrice = vert; rédactrice = jaune).',
	'info_gauche_auteurs_exterieurs' => 'Les auteures extérieures, sans accès au site, sont indiqués par une icone bleue ;
		les auteures effacés par une icone grise.',
	...
	'info_gauche_visiteurs_enregistres' => 'Vous trouverez ici les visiteuses enregistrés
	...
	'info_inscription_automatique' => 'Inscription automatique de nouveaux rédactrices',
...
réinstallation de SPIP pour recréer une nouvelle base ainsi qu\'un premier accès administratrice.',
  ...
  Ces fichiers peuvent vous servir à restreindre l\'accès aux auteures
  et administratrices en d\'autres endroits de votre site
  ...
  des fichiers).</p>',
	...
	'texte_plusieurs_articles' => 'Plusieurs auteures trouvés pour "@cherche_auteur@":',
