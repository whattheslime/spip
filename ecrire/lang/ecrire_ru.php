...
Статус автора обозначен цветом (администратор = зеленый; автор = желтый).',
 ...
 SPIP Файлы.}}',
  ...
  (недавно изданные статьи и новости).',
	...
	'info_pour' => 'для',
	'info_preview_texte' => 'Настройки пред. просмотра. Вы можете посмотреть как выглядят на сайте  материалы со статусом «утверждается». Включить эту возможность для всех авторов, только для администраторов или отключить вообще?',
