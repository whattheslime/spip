...
return [
	...
	'avis_connexion_ldap_echec_3' => 'Кроме того, не используйте поддержку LDAP для импорта пользователей.', # MODIF
	...
	'bouton_radio_apparaitre_liste_redacteurs_connectes' => 'Показывать в списке находящихся на сайте редакторов', # MODIF
	...
	'bouton_radio_non_apparaitre_liste_redacteurs_connectes' => 'Не показывать в списке находящихся на сайте редакторов', # MODIF
	...
	// C
	'cache_modifiable_webmestre' => 'Этот параметр может быть изменен только вебмастером.', # MODIF
	...
	'entree_informations_connexion_ldap' => 'Пожалуйста укажите параметры подключения к LDAP. Вы можете получить эту информацию у вашего системного администратора.', # MODIF
...
Также вы можете задать константы @constantes@ (в файле mes_options.php) так, чтобы эти файлы находились вне папки @document_root@.',
	...
	'info_admin_statuer_webmestre' => 'Сделать администратора вебмастером сайта', # MODIF
	'info_admin_webmestre' => 'Администратор является <b>вебмастером</b>', # MODIF
	'info_administrateur' => 'Администратор', # MODIF
	'info_administrateur_1' => 'Aдминистратор', # MODIF
	'info_administrateur_2' => 'на этом сайте (<i>использовать с осторожностью</i>)',
	'info_administrateur_site_01' => 'Если Вы администратор сайта, пожалуйста', # MODIF
	'info_administrateur_site_02' => 'нажмите на эту ссылку',
	'info_administrateurs' => 'Администраторы', # MODIF
 ...
 прошение о публикации и утверждение статьи.', # MODIF
	...
	'info_forums_abo_invites' => 'Ваш сайт содержит форумы по подписке; посетители могут зарегистрироваться на них на основном сайте.', # MODIF
...
Статус автора обозначен цветом (администратор = зеленый; автор = желтый).', # MODIF
	...
	'info_gauche_messagerie' => 'Передача сообщений позволяет обмениваться сообщениями между редакторами, сохранять записки (для вашего личного использования) или показывать объявления на основной странице административной части (если вы - администратор).', # MODIF
 ...
 SPIP не могут быть осуществлены.',
	...
	'info_liste_redacteurs_connectes' => 'Авторы онлайн', # MODIF
 ...
 SPIP Файлы.}}',
  ...
  Языки, уже используемые Вашим сайтом(в верху списка) не могут быть отключены.', # MODIF
  ...
  (недавно изданные статьи и новости).',
	...
	'info_option_accepter_visiteurs' => 'Включить регистрацию посетителей на сайте', # MODIF
	'info_option_ne_pas_accepter_visiteurs' => 'Отключить регистрацию посетителей на сайте', # MODIF
	...
	'info_pour' => 'для',
	'info_preview_texte' => 'Использование предварительного просмотра. Вы можете посмотреть как выглядят на сайте  материалы со статусом «утверждается». Включить эту возможность для всех авторов, только для администраторов или отключить вообще?', # MODIF
	...
	'info_reserve_admin' => 'Только администраторы могут изменить этот адрес.', # MODIF
	...
	'info_statut_administrateur' => 'Администратор', # MODIF
	...
	'info_statut_utilisateurs_1' => 'Статус по умолчанию для импортированных пользователей', # MODIF
	'info_statut_utilisateurs_2' => 'Выберите статус, характерный для  присутствующих людей в каталоге LDAP, когда они подключаются впервые. Позже, Вы можете изменить это значение для каждого автора индивидуально.', # MODIF
...
Переводы связанные с оригиналом, 
 в цвете указывающем на их статус:в цвете, указывающем их статус:',
	...
	'info_webmestre_forces' => 'Список вебмастеров содержится в <tt>@file_options@</tt>.', # MODIF
	...
	'item_administrateur_2' => 'администратор', # MODIF
	...
	'item_choix_administrateurs' => 'администраторы', # MODIF
...
<p>Если у вас нет необходимости в таких действиях, то оставьте значение по умолчанию.</p>', # MODIF
	...
	'texte_messagerie_agenda' => 'Система отправки сообщений позволяет авторам сайта общаться непосредственно в редакторской части сайта. Она связана с календарем.', # MODIF
