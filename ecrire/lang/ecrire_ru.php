...
Также вы можете задать константы @constantes@ (в файле mes_options.php) так, что бы эти файлы находились все папки @document_root@.',
	...
	'icone_creer_mot_cle' => 'Создать ключевое слово и добавить к статье',
	...
	'info_1_mot_cle' => '1 ключевое слово',
...
Статус автора обозначен цветом (администратор = зеленый; автор = желтый).',
 ...
 SPIP Файлы.}}',
  ...
  Языки, уже используемые Вашим сайтом(в верху списка) не могут быть отключены.',
	...
	'info_nb_mots_cles' => '@nb@ ключевых слов',
  ...
  (недавно изданные статьи и новости).',
	...
	'info_pour' => 'для',
	'info_preview_texte' => 'Настройки пред. просмотра. Вы можете посмотреть как выглядят на сайте  материалы со статусом «утверждается». Включить эту возможность для всех авторов, только для администраторов или отключить вообще?', # MODIF
	...
	'info_site_web' => 'САЙТ:',
	'info_sites' => 'сайты',
	'info_sites_lies_mot' => 'Сайты с этим ключевым словом',
...
<li>язык по умолчанию для   административной части. </li> </ul>',
	...
	'titre_ajouter_un_mot' => 'Добавить ключевое слово',
