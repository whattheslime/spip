...
return [
	...
	'avis_connexion_erreur_fichier_cle_manquant_1' => 'L’installation doit être faite par un·e webmestre avec un backup des clés et son mot de passe',
	'avis_connexion_erreur_fichier_cle_manquant_2' => 'L’installation doit être faite par un·e webmestre avec un backup des clés',
	...
	'avis_connexion_ldap_echec_3' => 'Alternativement, n’utilisez pas le support LDAP pour importer des comptes.',
	...
	'bouton_radio_apparaitre_liste_redacteurs_connectes' => 'Apparaître dans la liste des personnes connectées',
	...
	'bouton_radio_non_apparaitre_liste_redacteurs_connectes' => 'Ne pas apparaître dans la liste des personnes connectées',
	...
	// C
	'cache_modifiable_webmestre' => 'Ce paramètre est modifiable par un·e webmestre du site.',
	...
	'info_admin_statuer_webmestre' => 'Donner à cet admin les droits de webmestre',
	'info_admin_webmestre' => 'Cet admin est <b>webmestre</b>',
	'info_administrateur' => 'Admin',
	'info_administrateur_1' => 'Admin',
	'info_administrateur_2' => 'du site (<i>utilisez avec précaution</i>)',
	'info_administrateur_site_01' => 'Si vous êtes admin du site, veuillez',
	...
	'info_chemin_acces_2' => 'Vous devez désormais configurer le chemin d’accès aux informations dans l’annuaire. Cette information est indispensable pour lire les données de l’annuaire.',
...
exige d’avoir un accès FTP au site Web.</p>',
 ...
 Leur statut est indiqué par la couleur de leur icone (admin = vert ; rédacteur = jaune).',
	...
	'info_gauche_messagerie' => 'La messagerie vous permet d’échanger des messages entre comptes, de conserver des pense-bêtes (pour votre usage personnel) ou d’afficher des annonces sur la page d’accueil de l’espace privé (si vous êtes admin).',
	...
	'info_inscription_automatique' => 'Inscription automatique de nouveaux comptes',
	...
	'info_liste_redacteurs_connectes' => 'Liste des personnes connectées',
	...
	'info_option_accepter_visiteurs' => 'Accepter la création de comptes visiteurs sur le site public',
	'info_option_ne_pas_accepter_visiteurs' => 'Refuser la création de comptes visiteurs',
	...
	'info_pour' => 'pour',
	'info_preview_texte' => 'Il est possible de prévisualiser les différents éléments éditoriaux du site ayant au moins le statut « proposé », ainsi que les éléments en cours de rédaction dont on est l’auteur. Pour quel statut cette fonctionnalité doit-elle être disponible ?',
	...
	'info_question_accepter_visiteurs' => 'Si les squelettes de votre site prévoient la création de comptes sans accès à l’espace privé, veuillez activer l’option ci-dessous :',
  ...
  impossible.</div>',
	...
	'info_reserve_admin' => 'Seuls les admins peuvent modifier cette adresse.',
	...
	'info_statut_utilisateurs_1' => 'Statut par défaut des comptes importés',
	'info_statut_utilisateurs_2' => 'Choisissez le statut qui est attribué aux personnes présentes dans l’annuaire LDAP lorsqu’elles se connectent pour la première fois. Vous pourrez par la suite modifier cette valeur au cas par cas.',
...
dans une couleur qui indique leur état :',
	...
	'item_choix_administrateurs' => 'les admins',
...
réinstallation de SPIP pour recréer une nouvelle base ainsi qu’un premier accès admin.',
	...
	'texte_annuaire_ldap_1' => 'Si vous avez accès à un annuaire (LDAP), vous pouvez l’utiliser pour importer automatiquement des comptes sous SPIP.',
	...
	'texte_auteur_messagerie' => 'L’espace privé affiche en permanence la liste des personnes qui y sont connectées, ce qui vous permet d’échanger des messages en direct. Vous pouvez décider de ne pas apparaître dans cette liste (vous êtes « invisible » pour les autres).',
...
<p>Si vous n’en avez pas l’utilité, vous pouvez laisser cette option à sa valeur par défaut (pas de création des fichiers).</p>',
	...
	'texte_messagerie_agenda' => 'Cette messagerie permet d’échanger dans l’espace privé du site. Elle est associée à un agenda.',
