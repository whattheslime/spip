...
return [
	...
	'avis_connexion_ldap_echec_3' => 'Alterntivamente, não use o suporte LDAP para importar contas.',
	...
	'bouton_radio_apparaitre_liste_redacteurs_connectes' => 'Exibir na lista de pessoas conectadas',
	...
	'bouton_radio_non_apparaitre_liste_redacteurs_connectes' => 'Não exibir na lista de pessoas contectadas',
	...
	// C
	'cache_modifiable_webmestre' => 'Este parâmetro é modificável por um webmaster do site.',
...
Estas informações deverão ser fornecidas pelo administrador do sistema ou da rede.',
	...
	'info_admin_statuer_webmestre' => 'Dar a este admin os direitos de webmaster',
	'info_admin_webmestre' => 'Este admin é <b>webmaster</b>',
	'info_administrateur' => 'Admin',
	'info_administrateur_1' => 'Admin',
	'info_administrateur_2' => 'do site (<i>use com cuidado</i>)',
	'info_administrateur_site_01' => 'Se você é admin do site, por favor,',
	'info_administrateur_site_02' => 'clique neste link',
	'info_administrateurs' => 'Admins',
	...
	'info_chemin_acces_2' => 'A partir daqui, você deverá configurar o caminho de acesso às informações do catálogo. Esta informação é indispensávelpara ler os dados do catálogo.',
	...
	'info_facilite_suivi_activite' => 'Para facilitar o acompanhamento da atividade editorial do site, o SPIP pode notificar por e-mail, por exemplo para uma mailing-list, os avisos de pedidos de publicação e de validações das matérias. Informe um ou mais endereços, separados por vírgula.',
	'info_fichiers_authent' => 'Arquivos de autenticação «.htpasswd»',
	'info_forums_abo_invites' => 'O seu site inclui fóruns por assinatura; a criação de conta está aberta no site público.',
...
Ela oferece acesso às diferentes funções de gerenciamento das bases de dados. Algumas dessas funções disparam um processo de autenticação específico que requer acesso por FTP ao servidor web.</p>',
	'info_gauche_auteurs' => 'Você encontra aqui todos os autores do site.
...
os autores excluídos por um ícone cinza.',
	'info_gauche_messagerie' => 'O sistema interno de mensagens permite a troca de mensagens entre contas, a criação de lembretes (para seu uso pessoal) ou a exibição de avisos na página de entrada da área privada (se você for admin).',
	...
	'info_liste_redacteurs_connectes' => 'Lista de pessoas conectadas',
	...
	'info_multi_langues_choisies' => 'Selecione a seguir os idiomas à disposição para redigir.
Os idiomas já utilizados no seu site (exibidos no topo da lista) não podem ser desativados.',
	...
	'info_option_accepter_visiteurs' => 'Aceitar a de contas visitantes no site público',
	'info_option_ne_pas_accepter_visiteurs' => 'Recusar a criação de contas visitantes',
	...
	'info_pour' => 'para',
	'info_preview_texte' => 'É possível visualizar os diferentes elementos editoriais do site que tenham  pelo menos o status de «proposto», bem como os elementos em fase de redação em que você é autor. Para qual status esta funcionalidade deve estar disponível?',
	...
	'info_question_accepter_visiteurs' => 'Se os templates do seu site prevêem a criação de contas sem acesso à área privada, ative a opção abaixo:',
	...
	'info_reserve_admin' => 'Apenas os admin podem alterar este endereço.',
	...
	'info_statut_utilisateurs_1' => 'Status padrão das contass importadas',
	'info_statut_utilisateurs_2' => 'Escolha o status atribuído às pessoas que constam do catálogo LDAP, quando se conectarem pela primeira vêz. Você poderá, em seguida, alterar caso a caso este valor para cada autor.',
...
As traduções estão associadas ao original, numa côr que indica o seu status:',
	...
	'info_webmestre_forces' => 'Os webmasters são definidos em <code>@file_options@</code>.',
	...
	'item_choix_administrateurs' => 'os admins',
	...
	'label_choisir_timezone' => 'Fuso horário do site',
	...
	'texte_admin_effacer_01' => 'Este comando apaga <i>todo</i> o conteúdo da base de dados, incluindo <i>todos</i> os acessos à área restrita. Após executá-lo, você deverá reinstalar o SPIP para recriar uma nova base de dados bem como um acesso inicial de admin.',
	...
	'texte_annuaire_ldap_1' => 'Se você tem acesso a um catálogo LDAP, você poderá utilizá-lo para importar automaticamente as contas para o SPIP.',
	...
	'texte_auteur_messagerie' => 'A área restrita exibe permanentemente a lista de pessoas que estão conectadas, permitindo-lhe trocar mensagens em tempo real. Você pode decidir não aparecer nessa lista (ficando «invisível» para os outros).',
	...
	'texte_fichier_authent' => '<b>O SPIP pode criar os arquivos especiais  <tt>.htpasswd</tt> e <tt>.htpasswd-admin</tt> no diretório @dossier@?</b>
...
<p>Se eles não forem úteis, você poderá deixar esta opção com o seu valor padrão (sem criar os arquivos).</p>',
	...
	'texte_messagerie_agenda' => 'As mensagens internas permitem a interação na área restrita do site. Elas estão vinculadas a um calendário.',
...
Se o problema persistir, contate o seu serviço de hospedagem.</p>',
 ...
 <li>o idioma padrão exibido na área privada.</li></ul>',
	...
	'texte_travail_collaboratif' => 'Se é frequente acontecer de diversas pessoas trabalharem numa mesma matéria, o sistema pode exibir as matérias recentemente «abertas», para evitar modificações simultâneas. Esta opção está desativada por padrão, para evitar a exibição de mensagens de aviso desnecessárias.',
	'texte_vide' => 'vazia',
