...
$essais = [
	['avant<code>toto</code>apres', ',^avant<code[^>]*>toto</code>apres$,', ',^avant<code>toto</code>apres$,'], [
		...
		",^avant<script language=\"JavaScript\" type=\"text/javascript\">titi</script>\n\n<noscript>notiti</noscript>apres$,",
	], ['avant <html>toto</html> apres', ',^avant toto apres$,', ',^avant <html>toto</html> apres$,'], [
...
foreach ($essais as $i => $e) {
	for ($no_transform = 0; $no_transform <= 1; ++$no_transform) {
