<?php
  ...
  $table = "spip_test_tintin";
		...
		// affichage
		if ($err) {
			return '<b>Alter : drop column</b><dl><dd>' . implode('</dd><dd>', $err) . '</dd></dl>';
		}			
	}
  ...
  $table = "spip_test_tintin";
		...
		// affichage
		if ($err) {
			return '<b>Alter : renomme table</b><dl><dd>' . implode('</dd><dd>', $err) . '</dd></dl>';
		}			
	}
  ...
  $table = "spip_test_milou";
		...
		// affichage
		if ($err) {
			return '<b>Alter : index</b><dl><dd>' . implode('</dd><dd>', $err) . '</dd></dl>';
		}
	}
  ...
  $table = "spip_test_kirikou";
		...
		// affichage
		if ($err) {
			return '<b>Alter : primary key</b><dl><dd>' . implode('</dd><dd>', $err) . '</dd></dl>';
		}
	}
  ...
  $table = "spip_test_milou";
		...
		// affichage
		if ($err) {
			return '<b>Alter : multiples</b><dl><dd>' . implode('</dd><dd>', $err) . '</dd></dl>';
		}
	}
