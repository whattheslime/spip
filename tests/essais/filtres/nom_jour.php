<?php
/**
 * Test unitaire de la fonction nom_jour
...
function pretest_filtres_nom_jour() {
 ...
 * @return mixed
 */
function test_filtres_nom_jour(...$args) {
	return nom_jour(...$args);
}
 ...
 */
function essais_filtres_nom_jour(){
		$essais = array (
  0 => 
  array (
    0 => '',
