<?php
/**
 * Test unitaire de la fonction heures_minutes
...
function pretest_filtres_heures_minutes(){
 ...
 * @return mixed
 */
function test_filtres_heures_minutes(...$args) {
	return heures_minutes(...$args);
}
 ...
 */
function essais_filtres_heures_minutes(){
		$essais = array (
  0 => 
  array (
    0 => '12h33min',
