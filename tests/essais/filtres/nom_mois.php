<?php
/**
 * Test unitaire de la fonction nom_mois
...
function pretest_filtres_nom_mois() {
 ...
 * @return mixed
 */
function test_filtres_nom_mois(...$args) {
	return nom_mois(...$args);
}
 ...
 */
function essais_filtres_nom_mois(){
		$essais = array (
  0 => 
  array (
    0 => '',
