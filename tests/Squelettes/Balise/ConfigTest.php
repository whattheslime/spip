...
class ConfigTest extends SquelettesTestCase {
	...
	public function testArraySerialize(): void {
		$templating = $this->getTemplating();
		$this->assertOkTemplate($templating, '[(#CONFIG{serie}|=={a:2:{s:3:"one";s:9:"element 1";s:3:"two";s:9:"element 2";}}oui)ok]');
		$this->assertOkTemplate($templating, '[(#CONFIG{serie,defaut}|=={a:2:{s:3:"one";s:9:"element 1";s:3:"two";s:9:"element 2";}}oui)ok]');
	}
	...
	public function testMetaArrayAssoc(): void {
		...
		$this->assertOkTemplate($templating, "[(#CONFIG{/meta/assoc,defaut,''}|=={#ARRAY{one,element 1,two,element 2}}|oui)ok]");
	}

	public function testMetaArraySerialize(): void {
		$templating = $this->getTemplating();
		$this->assertOkTemplate($templating, '[(#CONFIG{/meta/serie}|=={a:2:{s:3:"one";s:9:"element 1";s:3:"two";s:9:"element 2";}}oui)ok]');
	...
	public function testAutreTableArrayAssoc(): void {
		...
		$this->assertOkTemplate($templating, "[(#CONFIG{/toto/tassoc,defaut,''}|=={#ARRAY{one,element 1,two,element 2}}|oui)ok]");
	}

	public function testAutreTableArraySerialize(): void {
		$templating = $this->getTemplatingOtherTable();
		$this->assertOkTemplate($templating, '[(#CONFIG{/toto/tserie}|=={a:2:{s:3:"one";s:9:"element 1";s:3:"two";s:9:"element 2";}}oui)ok]');
		$this->assertOkTemplate($templating, '[(#CONFIG{/toto/tserie,defaut}|=={a:2:{s:3:"one";s:9:"element 1";s:3:"two";s:9:"element 2";}}oui)ok]');
	}
}
