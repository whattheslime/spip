...
class TesterUrlAbsolueTest extends TestCase
{
    ...
    {
        return [0 => [0 => true, 1 => 'http://www.spip.net/'], 1 => [0 => true, 1 => 'https://www.spip.net/'], 2 => [0 => true, 1 => 'http://www.spip.net/sousrep/fr/'], 3 => [0 => true, 1 => 'ftp://www.spip.net/'], 4 => [0 => true, 1 => '//www.spip.net/'], 5 => [0 => false, 1 => '/spip/?page=sommaire'], 6 => [0 => false, 1 => 'spip/?page=sommaire']];
    }
}
